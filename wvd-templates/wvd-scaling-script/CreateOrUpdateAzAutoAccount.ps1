...
<#
.SYNOPSIS
	v1.0.0 - ANS (Updated to point at custom version)
...
param(
	...
	[Parameter(mandatory = $false)]
	[string]$ArtifactsURI = 'https://raw.githubusercontent.com/ans-cloud/RDS-Templates/master/wvd-templates/wvd-scaling-script'
)
